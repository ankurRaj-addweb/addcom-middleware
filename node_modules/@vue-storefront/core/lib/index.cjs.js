...
var getIntegrationConfig = function (context, configuration) {
    var _a;
    var baseURL = (_a = context === null || context === void 0 ? void 0 : context.$config) === null || _a === void 0 ? void 0 : _a.middlewareUrl;
    var cookie = getCookies(context);
    return merge({
        axios: {
            baseURL: /\/api\//gi.test(baseURL) ? baseURL : "".concat(baseURL, "/api/"),
